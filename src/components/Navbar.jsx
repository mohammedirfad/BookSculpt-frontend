...
const navigation = [
  ...
  { name: 'Add-Book', href: '/addbook', current: false },
...
Cart:null,
  ...
  return (
    <Disclosure as="nav" className="bg-transparent z-1">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex gap-3 flex-shrink-0 items-center">
                  <img
                    ...
                    alt="Your Company"
                  />
                  <h1 className='text-white font-bold text-2xl'>BookSculpt
</h1>
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex gap-3 items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {
                    token ?<div onClick={HandleLogout}>
                    <h1 className='text-white'>Logout</h1>
                </div> :<div onClick={()=>setOpen(true)} className='rounded-md bg-gray-900'>
                    <h1 className='text-white mx-2  my-1'>Login</h1>
                </div>
                }
                <Login open={Open} setOpen={setOpen} start={start} stop={stop}/>
                <Signup open={start} setOpen={stop} start={setOpen} />
                <button
                  type="button"
